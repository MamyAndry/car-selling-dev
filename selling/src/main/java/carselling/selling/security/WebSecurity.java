        ...
        http.csrf().disable()
            .cors().and()
                ...
                .requestMatchers(
                    ...
                    ,AntPathRequestMatcher.antMatcher(HttpMethod.GET,"/origin")
                    ,AntPathRequestMatcher.antMatcher(HttpMethod.GET,"/carStatus")
                    ,AntPathRequestMatcher.antMatcher(HttpMethod.GET,"/fuelType")
                    ,AntPathRequestMatcher.antMatcher(HttpMethod.GET,"/commission")
